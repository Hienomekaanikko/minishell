...
SRC = main.c init_base.c init_loop.c lexer.c lexer_utils.c ast_builder.c execution.c execution_utils.c builtins.c exec_pipe.c envp.c arena.c exec_redir.c builtin_export.c builtin_echo.c expansions.c ast_set_complex.c ast_utils.c ast_utils2.c var_list.c var_list_utils.c expansion_utils.c free_mem.c signals.c exec_error.c graphics.c find_executables.c here_doc.c parser.c parser_utils.c rl_handler.c
OBJS = $(SRC:.c=.o)
